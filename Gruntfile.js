        ...
        ngAnnotate: {
            ...
            app: { //"app" target if not work add /js files
                files: {
                    ...
                    './min-safe/js/certs.controller.js': ['./controllers/certs.controller.js'],
                    ...
                    './min-safe/js/stats.controller.js': ['./controllers/stats.controller.js'],
                    './min-safe/js/mits.controller.js': ['./controllers/mits.controller.js'],
                    './min-safe/js/news.controller.js': ['./controllers/news.controller.js'],
